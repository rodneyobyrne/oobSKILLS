(function () {
  ...
  function renderResult(data, evaluation) {
    ...
    resultContent.innerHTML = `
      ...
      <section class="tool-consideration"><p class="meta">Decision support, not a shopping list</p><h3>Useful tools to consider</h3><p>These are categories that may be worth looking at based on your answers. They are not automatic recommendations, and you may already have software capable of doing the job.</p><div class="tool-grid">${toolCards(evaluation.usefulTools)}</div></section>
